...
O `glue` um pacote novo, apareceu pela primeira vez no Git-Hub em dezembro de 2016. Assim como `stringr`, o `glue` serve para interpolar dados,colar pequenos textos e concatenar.  
...
str_c(info[1], info[2], info[3], sep = " ")
```
